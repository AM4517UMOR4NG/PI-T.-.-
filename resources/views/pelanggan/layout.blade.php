...
<style>
    ...
    .card {
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 0 0 1px var(--card-border), 0 4px 6px rgba(0, 0, 0, 0.05);
        border-radius: 16px;
    }
    
    /* Dark mode card border lebih terang - menggunakan box-shadow */
    [data-theme="dark"] .card {
        box-shadow: 0 0 0 1px #475569, 0 4px 6px rgba(0, 0, 0, 0.15);
    }

    /* Card dengan garis biru kiri - menggunakan box-shadow inset */
    .card.card-blue-left {
        position: relative;
        box-shadow: inset 4px 0 0 0 #0652DD, 0 0 0 1px var(--card-border), 0 4px 6px rgba(0, 0, 0, 0.05);
    }
    
    /* Dark mode - garis biru dan border lebih terlihat */
    [data-theme="dark"] .card.card-blue-left {
        box-shadow: inset 4px 0 0 0 #3b82f6, 0 0 0 1px #475569, 0 4px 6px rgba(0, 0, 0, 0.15);
    }
