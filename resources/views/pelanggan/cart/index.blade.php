        ...
        <div class="card-footer bg-transparent border-top" style="border-color: #E5E7EB; padding-top: 1.5rem; padding-bottom: 1.5rem;">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                <div>
                    ...
                    <div class="h5 fw-bold grand-total" id="grand-total">Rp {{ number_format($total, 0, ',', '.') }}</div>
                </div>
                <div>
...
<script>
    ...
    function updateGrandTotal() {
        ...
        // Try multiple selectors to find grand total element
        const grandTotalElement = document.getElementById('grand-total') || document.querySelector('.grand-total');
